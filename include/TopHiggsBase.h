...
// Tue Jun 18 11:48:01 2013 by ROOT version 5.32/00
// from TTree ntp1/ntp1
// found on file: root://eoscms//eos/cms/store/cmst3/user/crovelli/CMST3/tH/tH125q_blvu_Yt1_H126toWW/default_MC_9_1_J9R.root
//////////////////////////////////////////////////////////

#ifndef TopHiggsBase_h
#define TopHiggsBase_h
...
public :
   ...
   Float_t         correctedEcalEnergyEle[100];   //[nEle]
   Float_t         correctedEcalEnergyErrorEle[100];   //[nEle]
   ...
   Float_t         mvaidisotrigEle[100];   //[nEle]
   ...
   Float_t         pfCandChargedPUIso03Ele[100];   //[nEle]
   Float_t         pfCandChargedPUIso04Ele[100];   //[nEle]
   Int_t           nCalibEle;
   Int_t           chargeCalibEle[100];   //[nCalibEle]
   Float_t         energyCalibEle[100];   //[nCalibEle]
   Float_t         thetaCalibEle[100];   //[nCalibEle]
   Float_t         etaCalibEle[100];   //[nCalibEle]
   Float_t         phiCalibEle[100];   //[nCalibEle]
   Float_t         pxCalibEle[100];   //[nCalibEle]
   Float_t         pyCalibEle[100];   //[nCalibEle]
   Float_t         pzCalibEle[100];   //[nCalibEle]
   Float_t         vertexXCalibEle[100];   //[nCalibEle]
   Float_t         vertexYCalibEle[100];   //[nCalibEle]
   Float_t         vertexZCalibEle[100];   //[nCalibEle]
   Float_t         energyErrorCalibEle[100];   //[nCalibEle]
   Int_t           nPho;
   Int_t           nPerPVPho;
   ...
   Float_t         dr01NeutralHadronPFIsoPho[100];   //[nPho]
   Float_t         dr01PhotonPFIsoPho[100];   //[nPho]
   Float_t         dr02NeutralHadronPFIsoPho[100];   //[nPho]
   Float_t         dr02PhotonPFIsoPho[100];   //[nPho]
   Float_t         dr03NeutralHadronPFIsoPho[100];   //[nPho]
   Float_t         dr03PhotonPFIsoPho[100];   //[nPho]
   Float_t         dr04NeutralHadronPFIsoPho[100];   //[nPho]
   Float_t         dr04PhotonPFIsoPho[100];   //[nPho]
   Float_t         dr05NeutralHadronPFIsoPho[100];   //[nPho]
   Float_t         dr05PhotonPFIsoPho[100];   //[nPho]
   Float_t         dr06NeutralHadronPFIsoPho[100];   //[nPho]
   Float_t         dr06PhotonPFIsoPho[100];   //[nPho]
   Float_t         dr01ChargedHadronPFIsoPho[342];   //[nPerPVPho]
   Float_t         dr02ChargedHadronPFIsoPho[342];   //[nPerPVPho]
   Float_t         dr03ChargedHadronPFIsoPho[342];   //[nPerPVPho]
   Float_t         dr04ChargedHadronPFIsoPho[342];   //[nPerPVPho]
   Float_t         dr05ChargedHadronPFIsoPho[342];   //[nPerPVPho]
   Float_t         dr06ChargedHadronPFIsoPho[342];   //[nPerPVPho]
   Int_t           nConv;
   ...
   Int_t           nPhoPFSC;
   Int_t           nBCPhoPFSC[500];   //[nPhoPFSC]
   Int_t           nCrystalsPhoPFSC[500];   //[nPhoPFSC]
   Float_t         rawEnergyPhoPFSC[500];   //[nPhoPFSC]
   Float_t         energyPhoPFSC[500];   //[nPhoPFSC]
   Float_t         seedClusterEnergyPhoPFSC[500];   //[nPhoPFSC]
   Float_t         esEnergyPhoPFSC[500];   //[nPhoPFSC]
   Float_t         etaPhoPFSC[500];   //[nPhoPFSC]
   Float_t         thetaPhoPFSC[500];   //[nPhoPFSC]
   Float_t         phiPhoPFSC[500];   //[nPhoPFSC]
   Float_t         xPosPhoPFSC[500];   //[nPhoPFSC]
   Float_t         yPosPhoPFSC[500];   //[nPhoPFSC]
   Float_t         zPosPhoPFSC[500];   //[nPhoPFSC]
   Float_t         phiWidthPhoPFSC[500];   //[nPhoPFSC]
   Float_t         etaWidthPhoPFSC[500];   //[nPhoPFSC]
   Float_t         e3x3PhoPFSC[500];   //[nPhoPFSC]
   Float_t         e3x1PhoPFSC[500];   //[nPhoPFSC]
   Float_t         e1x3PhoPFSC[500];   //[nPhoPFSC]
   Float_t         e4x4PhoPFSC[500];   //[nPhoPFSC]
   Float_t         e5x5PhoPFSC[500];   //[nPhoPFSC]
   Float_t         eMaxPhoPFSC[500];   //[nPhoPFSC]
   Float_t         e2x2PhoPFSC[500];   //[nPhoPFSC]
   Float_t         e2ndPhoPFSC[500];   //[nPhoPFSC]
   Float_t         e1x5PhoPFSC[500];   //[nPhoPFSC]
   Float_t         e2x5MaxPhoPFSC[500];   //[nPhoPFSC]
   Float_t         e2x5LeftPhoPFSC[500];   //[nPhoPFSC]
   Float_t         e2x5RightPhoPFSC[500];   //[nPhoPFSC]
   Float_t         e2x5TopPhoPFSC[500];   //[nPhoPFSC]
   Float_t         e2x5BottomPhoPFSC[500];   //[nPhoPFSC]
   Float_t         eLeftPhoPFSC[500];   //[nPhoPFSC]
   Float_t         eRightPhoPFSC[500];   //[nPhoPFSC]
   Float_t         eTopPhoPFSC[500];   //[nPhoPFSC]
   Float_t         eBottomPhoPFSC[500];   //[nPhoPFSC]
   Float_t         e4SwissCrossPhoPFSC[500];   //[nPhoPFSC]
   Float_t         covIEtaIEtaPhoPFSC[500];   //[nPhoPFSC]
   Float_t         covIEtaIPhiPhoPFSC[500];   //[nPhoPFSC]
   Float_t         covIPhiIPhiPhoPFSC[500];   //[nPhoPFSC]
   Float_t         sMajPhoPFSC[500];   //[nPhoPFSC]
   Float_t         sMinPhoPFSC[500];   //[nPhoPFSC]
   Float_t         alphaPhoPFSC[500];   //[nPhoPFSC]
   Float_t         hOverEPhoPFSC[500];   //[nPhoPFSC]
   Int_t           recoFlagPhoPFSC[500];   //[nPhoPFSC]
   Float_t         timePhoPFSC[500];   //[nPhoPFSC]
   Float_t         chi2PhoPFSC[500];   //[nPhoPFSC]
   Float_t         seedEnergyPhoPFSC[500];   //[nPhoPFSC]
   Float_t         seedXPhoPFSC[500];   //[nPhoPFSC]
   Float_t         seedYPhoPFSC[500];   //[nPhoPFSC]
   Float_t         esEffsIxIxPhoPFSC[500];   //[nPhoPFSC]
   Float_t         esEffsIyIyPhoPFSC[500];   //[nPhoPFSC]
   Float_t         esL1EnergyPhoPFSC[500];   //[nPhoPFSC]
   Float_t         esL2EnergyPhoPFSC[500];   //[nPhoPFSC]
   Int_t           esL1StripsPhoPFSC[500];   //[nPhoPFSC]
   Int_t           esL2StripsPhoPFSC[500];   //[nPhoPFSC]
   Int_t           nBC;
   Float_t         etaBC[500];   //[nBC]
   Float_t         thetaBC[500];   //[nBC]
   Float_t         phiBC[500];   //[nBC]
   Float_t         etaCrystalBC[500];   //[nBC]
   Float_t         phiCrystalBC[500];   //[nBC]
   Int_t           iEtaBC[500];   //[nBC]
   Int_t           iPhiBC[500];   //[nBC]
   Float_t         thetaTiltBC[500];   //[nBC]
   Float_t         phiTiltBC[500];   //[nBC]
   Int_t           indexSCBC[500];   //[nBC]
   Int_t           nPFBC;
   Float_t         etaPFBC[500];   //[nPFBC]
   Float_t         thetaPFBC[500];   //[nPFBC]
   Float_t         phiPFBC[500];   //[nPFBC]
   Float_t         etaCrystalPFBC[500];   //[nPFBC]
   Float_t         phiCrystalPFBC[500];   //[nPFBC]
   Int_t           iEtaPFBC[500];   //[nPFBC]
   Int_t           iPhiPFBC[500];   //[nPFBC]
   Float_t         thetaTiltPFBC[500];   //[nPFBC]
   Float_t         phiTiltPFBC[500];   //[nPFBC]
   Int_t           indexSCPFBC[500];   //[nPFBC]
   Int_t           nPhoPFBC;
   Float_t         etaPhoPFBC[500];   //[nPhoPFBC]
   Float_t         thetaPhoPFBC[500];   //[nPhoPFBC]
   Float_t         phiPhoPFBC[500];   //[nPhoPFBC]
   Float_t         etaCrystalPhoPFBC[500];   //[nPhoPFBC]
   Float_t         phiCrystalPhoPFBC[500];   //[nPhoPFBC]
   Int_t           iEtaPhoPFBC[500];   //[nPhoPFBC]
   Int_t           iPhiPhoPFBC[500];   //[nPhoPFBC]
   Float_t         thetaTiltPhoPFBC[500];   //[nPhoPFBC]
   Float_t         phiTiltPhoPFBC[500];   //[nPhoPFBC]
   Int_t           indexSCPhoPFBC[500];   //[nPhoPFBC]
   Int_t           nTrack;
   ...
   Float_t         pfIsolationSumPUPtR03Muon[200];   //[nMuon]
   Float_t         pfIsolationSumPUPtR04Muon[200];   //[nMuon]
   Float_t         pfCandChargedPUIso03Muon[200];   //[nMuon]
   Float_t         pfCandChargedPUIso04Muon[200];   //[nMuon]
   ...
   Float_t         thehpsTauDiscrAgainstMuonLoose2PFTau[500];   //[nPFTau]
   Float_t         thehpsTauDiscrAgainstMuonMedium2PFTau[500];   //[nPFTau]
   Float_t         thehpsTauDiscrAgainstMuonTight2PFTau[500];   //[nPFTau]
   Float_t         thehpsTauDiscrByLooseCombinedIsolationDeltaBetaCorr3HitsPFTau[500];   //[nPFTau]
   Float_t         thehpsTauDiscrByMediumCombinedIsolationDeltaBetaCorr3HitsPFTau[500];   //[nPFTau]
   Float_t         thehpsTauDiscrByTightCombinedIsolationDeltaBetaCorr3HitsPFTau[500];   //[nPFTau]
   Float_t         thehpsTauDiscrAgainstElectronLooseMVA3PFTau[500];   //[nPFTau]
   Float_t         thehpsTauDiscrAgainstElectronMediumMVA3PFTau[500];   //[nPFTau]
   Float_t         thehpsTauDiscrAgainstElectronTightMVA3PFTau[500];   //[nPFTau]
   Float_t         thehpsTauDiscrAgainstElectronVTightMVA3PFTau[500];   //[nPFTau]
   ...
   Int_t           nPFCand;
   Int_t           chargePFCand[500];   //[nPFCand]
   Float_t         energyPFCand[500];   //[nPFCand]
   Float_t         thetaPFCand[500];   //[nPFCand]
   Float_t         etaPFCand[500];   //[nPFCand]
   Float_t         phiPFCand[500];   //[nPFCand]
   Float_t         pxPFCand[500];   //[nPFCand]
   Float_t         pyPFCand[500];   //[nPFCand]
   Float_t         pzPFCand[500];   //[nPFCand]
   Float_t         vertexXPFCand[500];   //[nPFCand]
   Float_t         vertexYPFCand[500];   //[nPFCand]
   Float_t         vertexZPFCand[500];   //[nPFCand]
   Int_t           particleIdPFCand[500];   //[nPFCand]
   Double_t        ChargedIso03PFCand[500];   //[nPFCand]
   Double_t        NeutralIso03PFCand[500];   //[nPFCand]
   Double_t        PhotonIso03PFCand[500];   //[nPFCand]
   Double_t        SumPUPtR03PFCand[500];   //[nPFCand]
   Int_t           nReducedPFCand;
   Int_t           chargeReducedPFCand[659];   //[nReducedPFCand]
   Float_t         energyReducedPFCand[659];   //[nReducedPFCand]
   Float_t         thetaReducedPFCand[659];   //[nReducedPFCand]
   Float_t         etaReducedPFCand[659];   //[nReducedPFCand]
   Float_t         phiReducedPFCand[659];   //[nReducedPFCand]
   Float_t         pxReducedPFCand[659];   //[nReducedPFCand]
   Float_t         pyReducedPFCand[659];   //[nReducedPFCand]
   Float_t         pzReducedPFCand[659];   //[nReducedPFCand]
   Float_t         vertexXReducedPFCand[659];   //[nReducedPFCand]
   Float_t         vertexYReducedPFCand[659];   //[nReducedPFCand]
   Float_t         vertexZReducedPFCand[659];   //[nReducedPFCand]
   Int_t           nMet;
   ...
   Float_t         axis1AK5PFNoPUJet[1000];   //[nAK5PFNoPUJet]
   Float_t         axis2AK5PFNoPUJet[1000];   //[nAK5PFNoPUJet]
   Float_t         pullAK5PFNoPUJet[1000];   //[nAK5PFNoPUJet]
   Float_t         tanaAK5PFNoPUJet[1000];   //[nAK5PFNoPUJet]
   Float_t         rmsCand_QCAK5PFNoPUJet[1000];   //[nAK5PFNoPUJet]
   Float_t         ptD_QCAK5PFNoPUJet[1000];   //[nAK5PFNoPUJet]
   Float_t         axis1_QCAK5PFNoPUJet[1000];   //[nAK5PFNoPUJet]
   Float_t         axis2_QCAK5PFNoPUJet[1000];   //[nAK5PFNoPUJet]
   Float_t         pull_QCAK5PFNoPUJet[1000];   //[nAK5PFNoPUJet]
   Float_t         tana_QCAK5PFNoPUJet[1000];   //[nAK5PFNoPUJet]
   Int_t           nChg_ptCutAK5PFNoPUJet[1000];   //[nAK5PFNoPUJet]
   Int_t           nChg_QCAK5PFNoPUJet[1000];   //[nAK5PFNoPUJet]
   Int_t           nChg_ptCut_QCAK5PFNoPUJet[1000];   //[nAK5PFNoPUJet]
   Int_t           nNeutral_ptCutAK5PFNoPUJet[1000];   //[nAK5PFNoPUJet]
   Float_t         RchgAK5PFNoPUJet[1000];   //[nAK5PFNoPUJet]
   Float_t         RneutralAK5PFNoPUJet[1000];   //[nAK5PFNoPUJet]
   Float_t         RAK5PFNoPUJet[1000];   //[nAK5PFNoPUJet]
   Float_t         Rchg_QCAK5PFNoPUJet[1000];   //[nAK5PFNoPUJet]
   Float_t         pTMaxAK5PFNoPUJet[1000];   //[nAK5PFNoPUJet]
   Float_t         pTMaxChgAK5PFNoPUJet[1000];   //[nAK5PFNoPUJet]
   Float_t         pTMaxNeutralAK5PFNoPUJet[1000];   //[nAK5PFNoPUJet]
   Float_t         pTMaxChg_QCAK5PFNoPUJet[1000];   //[nAK5PFNoPUJet]
   ...
   TBranch        *b_correctedEcalEnergyErrorEle;   //!
   ...
   TBranch        *b_thehpsTauDiscrAgainstMuonLoose2PFTau;   //!
   TBranch        *b_thehpsTauDiscrAgainstMuonMedium2PFTau;   //!
   TBranch        *b_thehpsTauDiscrAgainstMuonTight2PFTau;   //!
   TBranch        *b_thehpsTauDiscrByLooseCombinedIsolationDeltaBetaCorr3HitsPFTau;   //!
   TBranch        *b_thehpsTauDiscrByMediumCombinedIsolationDeltaBetaCorr3HitsPFTau;   //!
   TBranch        *b_thehpsTauDiscrByTightCombinedIsolationDeltaBetaCorr3HitsPFTau;   //!
   TBranch        *b_thehpsTauDiscrAgainstElectronLooseMVA3PFTau;   //!
   TBranch        *b_thehpsTauDiscrAgainstElectronMediumMVA3PFTau;   //!
   TBranch        *b_thehpsTauDiscrAgainstElectronTightMVA3PFTau;   //!
   TBranch        *b_thehpsTauDiscrAgainstElectronVTightMVA3PFTau;   //!
   ...
   TopHiggsBase(TTree *tree=0);
   virtual ~TopHiggsBase();
...
#ifdef TopHiggsBase_cxx
TopHiggsBase::TopHiggsBase(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("root://eoscms//eos/cms/store/cmst3/user/crovelli/CMST3/tH/tH125q_blvu_Yt1_H126toWW/default_MC_9_1_J9R.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("root://eoscms//eos/cms/store/cmst3/user/crovelli/CMST3/tH/tH125q_blvu_Yt1_H126toWW/default_MC_9_1_J9R.root");
      }
...
TopHiggsBase::~TopHiggsBase()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t TopHiggsBase::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t TopHiggsBase::LoadTree(Long64_t entry)
{
...
void TopHiggsBase::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("correctedEcalEnergyErrorEle", correctedEcalEnergyErrorEle, &b_correctedEcalEnergyErrorEle);
   ...
   fChain->SetBranchAddress("thehpsTauDiscrAgainstMuonLoose2PFTau", thehpsTauDiscrAgainstMuonLoose2PFTau, &b_thehpsTauDiscrAgainstMuonLoose2PFTau);
   fChain->SetBranchAddress("thehpsTauDiscrAgainstMuonMedium2PFTau", thehpsTauDiscrAgainstMuonMedium2PFTau, &b_thehpsTauDiscrAgainstMuonMedium2PFTau);
   fChain->SetBranchAddress("thehpsTauDiscrAgainstMuonTight2PFTau", thehpsTauDiscrAgainstMuonTight2PFTau, &b_thehpsTauDiscrAgainstMuonTight2PFTau);
   fChain->SetBranchAddress("thehpsTauDiscrByLooseCombinedIsolationDeltaBetaCorr3HitsPFTau", thehpsTauDiscrByLooseCombinedIsolationDeltaBetaCorr3HitsPFTau, &b_thehpsTauDiscrByLooseCombinedIsolationDeltaBetaCorr3HitsPFTau);
   fChain->SetBranchAddress("thehpsTauDiscrByMediumCombinedIsolationDeltaBetaCorr3HitsPFTau", thehpsTauDiscrByMediumCombinedIsolationDeltaBetaCorr3HitsPFTau, &b_thehpsTauDiscrByMediumCombinedIsolationDeltaBetaCorr3HitsPFTau);
   fChain->SetBranchAddress("thehpsTauDiscrByTightCombinedIsolationDeltaBetaCorr3HitsPFTau", thehpsTauDiscrByTightCombinedIsolationDeltaBetaCorr3HitsPFTau, &b_thehpsTauDiscrByTightCombinedIsolationDeltaBetaCorr3HitsPFTau);
   fChain->SetBranchAddress("thehpsTauDiscrAgainstElectronLooseMVA3PFTau", thehpsTauDiscrAgainstElectronLooseMVA3PFTau, &b_thehpsTauDiscrAgainstElectronLooseMVA3PFTau);
   fChain->SetBranchAddress("thehpsTauDiscrAgainstElectronMediumMVA3PFTau", thehpsTauDiscrAgainstElectronMediumMVA3PFTau, &b_thehpsTauDiscrAgainstElectronMediumMVA3PFTau);
   fChain->SetBranchAddress("thehpsTauDiscrAgainstElectronTightMVA3PFTau", thehpsTauDiscrAgainstElectronTightMVA3PFTau, &b_thehpsTauDiscrAgainstElectronTightMVA3PFTau);
   fChain->SetBranchAddress("thehpsTauDiscrAgainstElectronVTightMVA3PFTau", thehpsTauDiscrAgainstElectronVTightMVA3PFTau, &b_thehpsTauDiscrAgainstElectronVTightMVA3PFTau);
...
void TopHiggsBase::Show(Long64_t entry)
{
...
Int_t TopHiggsBase::Cut(Long64_t entry)
{
