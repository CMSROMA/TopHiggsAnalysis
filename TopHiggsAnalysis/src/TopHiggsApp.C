...
#include <TTree.h>
#include <TChain.h>
#include "TopHiggsAnalysis/include/Application.hh"
...
#endif
#if Application == 23
#include "TopHiggsAnalysis/src/tHSelection.cc"
#endif
...
int main(int argc, char* argv[]) {
  ...
  if ( argc < 2 ){
    ...
    std::cout << "./TopHiggsApp inputFile [outputFile] [1=MC,0=data] [dataset]" << std::endl;
    return 1;
  }
...
//   mask.requireTrigger("HLTXElectronMuonRelaxed");
  ...
  tHSelection tH(theChain);
  tH.SetDatasetName(outputFileName);

  std::vector<std::string>    maskEEE,    maskMMM,    maskEEM,    maskMME;
  std::vector<std::string> maskNotEEE, maskNotMMM, maskNotEEM, maskNotMME;
  ...
  if(isMC) {
    ...
    maskMMM.push_back("1-1:HLT_DoubleMu5_v1");
    maskMMM.push_back("1-1:HLT_Mu25_v1");

    maskEEM.push_back("1-1:HLT_Mu5_Ele17_v2");
    maskEEM.push_back("1-1:HLT_Mu25_v1");

    maskMME.push_back("1-1:HLT_Mu5_Ele17_v2");
    maskMME.push_back("1-1:HLT_Mu25_v1");
    */
    ...
    if(DatasetName.Contains("MuEG")) {
      ...
      maskEEM.push_back("1-175972:HLT_Mu17_Ele8_CaloIdL_v");
      maskEEM.push_back("175973-180252:HLT_Mu17_Ele8_CaloIdT_CaloIsoVL_v");
      maskEEM.push_back("1-167913:HLT_Mu8_Ele17_CaloIdL_v");
      maskEEM.push_back("167914-180252:HLT_Mu8_Ele17_CaloIdT_CaloIsoVL_v"); // end 2011
      maskEEM.push_back("190456-999999:HLT_Mu17_Ele8_CaloIdT_CaloIsoVL_TrkIdVL_TrkIsoVL_v");
      maskEEM.push_back("190456-999999:HLT_Mu8_Ele17_CaloIdT_CaloIsoVL_TrkIdVL_TrkIsoVL_v");

      maskMME.push_back("1-175972:HLT_Mu17_Ele8_CaloIdL_v");
      maskMME.push_back("175973-180252:HLT_Mu17_Ele8_CaloIdT_CaloIsoVL_v");
      maskMME.push_back("1-167913:HLT_Mu8_Ele17_CaloIdL_v");
      maskMME.push_back("167914-180252:HLT_Mu8_Ele17_CaloIdT_CaloIsoVL_v"); // end 2011
      maskMME.push_back("190456-999999:HLT_Mu17_Ele8_CaloIdT_CaloIsoVL_TrkIdVL_TrkIsoVL_v");
      maskMME.push_back("190456-999999:HLT_Mu8_Ele17_CaloIdT_CaloIsoVL_TrkIdVL_TrkIsoVL_v");

    }
    
    else if(DatasetName.Contains("DoubleElectron")) {

      maskEEE.push_back("1-170901:HLT_Ele17_CaloIdL_CaloIsoVL_Ele8_CaloIdL_CaloIsoVL_v");
      maskEEE.push_back("171050-180252:HLT_Ele17_CaloIdT_CaloIsoVL_TrkIdVL_TrkIsoVL_Ele8_CaloIdT_CaloIsoVL_TrkIdVL_TrkIsoVL_v"); // end 2011
      maskEEE.push_back("190456-999999:HLT_Ele17_CaloIdT_CaloIsoVL_TrkIdVL_TrkIsoVL_Ele8_CaloIdT_CaloIsoVL_TrkIdVL_TrkIsoVL_v");

      maskEEM.push_back("1-170901:HLT_Ele17_CaloIdL_CaloIsoVL_Ele8_CaloIdL_CaloIsoVL_v");
      maskEEM.push_back("171050-180252:HLT_Ele17_CaloIdT_CaloIsoVL_TrkIdVL_TrkIsoVL_Ele8_CaloIdT_CaloIsoVL_TrkIdVL_TrkIsoVL_v"); // end 2011
      maskEEM.push_back("190456-999999:HLT_Ele17_CaloIdT_CaloIsoVL_TrkIdVL_TrkIsoVL_Ele8_CaloIdT_CaloIsoVL_TrkIdVL_TrkIsoVL_v");

      maskNotEEM.push_back("1-175972:HLT_Mu17_Ele8_CaloIdL_v");
      maskNotEEM.push_back("175973-180252:HLT_Mu17_Ele8_CaloIdT_CaloIsoVL_v");
      maskNotEEM.push_back("1-167913:HLT_Mu8_Ele17_CaloIdL_v");
      maskNotEEM.push_back("167914-180252:HLT_Mu8_Ele17_CaloIdT_CaloIsoVL_v"); // end 2011
      maskNotEEM.push_back("190456-999999:HLT_Mu17_Ele8_CaloIdT_CaloIsoVL_TrkIdVL_TrkIsoVL_v");
      maskNotEEM.push_back("190456-999999:HLT_Mu8_Ele17_CaloIdT_CaloIsoVL_TrkIdVL_TrkIsoVL_v");


    } else if(DatasetName.Contains("DoubleMu")) {

      maskMMM.push_back("1-165208:HLT_DoubleMu7_v");
      maskMMM.push_back("165364-178419:HLT_Mu13_Mu8_v");
      maskMMM.push_back("178420-180252:HLT_Mu17_Mu8_v");
      maskMMM.push_back("175832-180252:HLT_Mu17_TkMu8_v"); // end 2011
      maskMMM.push_back("190456-999999:HLT_Mu17_Mu8_v");
      maskMMM.push_back("190456-999999:HLT_Mu17_TkMu8_v");

      maskMME.push_back("1-165208:HLT_DoubleMu7_v");
      maskMME.push_back("165364-178419:HLT_Mu13_Mu8_v");
      maskMME.push_back("178420-180252:HLT_Mu17_Mu8_v");
      maskMME.push_back("175832-180252:HLT_Mu17_TkMu8_v"); // end 2011
      maskMME.push_back("190456-999999:HLT_Mu17_Mu8_v");
      maskMME.push_back("190456-999999:HLT_Mu17_TkMu8_v");

      maskNotMME.push_back("1-175972:HLT_Mu17_Ele8_CaloIdL_v");
      maskNotMME.push_back("175973-180252:HLT_Mu17_Ele8_CaloIdT_CaloIsoVL_v");
      maskNotMME.push_back("1-167913:HLT_Mu8_Ele17_CaloIdL_v");
      maskNotMME.push_back("167914-180252:HLT_Mu8_Ele17_CaloIdT_CaloIsoVL_v"); // end 2011
      maskNotMME.push_back("190456-999999:HLT_Mu17_Ele8_CaloIdT_CaloIsoVL_TrkIdVL_TrkIsoVL_v");
      maskNotMME.push_back("190456-999999:HLT_Mu8_Ele17_CaloIdT_CaloIsoVL_TrkIdVL_TrkIsoVL_v");
