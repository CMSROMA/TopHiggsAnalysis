/// The TopHiggs class is an auxiliary class which contains basic
/// functionality useful for any analysis of Vecbos+jets events.
/// It derives from TopHiggsBase.

// It is a copy of Higgs class -- C. Jorda

#ifndef TopHiggs_h
#define TopHiggs_h

#include "EgammaAnalysisTools/include/ElectronLikelihood.h"
#include "TopHiggsAnalysis/include/TopHiggsBase.h"
...
class TopHiggs : public TopHiggsBase{
...
public:
  ...
  /// filter the good PVs
  bool goodPV(int v);
  /// for lepton ID MVA for B
  std::pair<int, int> tHmcMatch(int closestGen, bool isEle);
  float leptBDTForBs(IDForBsMVA *mva, int leptIndex, bool isEle);
